        ...
        <div className=" bg-gray-100 rounded-md w-11/12 h-11/12  " >
            ...
            <div className="w-full h-11/12 flex p-5">
                <div className="w-5/12 h-10/12 bg-gray-200 rounded-lg">
                    ...
                    <button onClick={handleSearch} className="bg-white rounded-lg p-2 ml-4">
              <img src={search} style={{ width: '24px', height: '24px' }} alt="search" />
            </button>                    </div>
                </div>
            ...
            <div className="w-7/12 flex-col">
                <div className="w-full h-3/6  mb-3 mr-3 ml-3 bg-gray-200 rounded-lg">
                    <div className="w-full h-10/12 bg-gray-200 rounded-lg">
                        ...
                        <div className=" w-full justify-center flex mt-5">
                            ...
                            <button onClick={handleDisable} className=" bg-white rounded-lg p-2 ml-4"> <img src={ban} style={{ width: '24px', height: '24px' }}></img> </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full h-10/12 bg-gray-200 rounded-lg">
                    ...
                    <div class=" w-3/6">
                        ...
                        <button onClick={handleEnable} className=" bg-white rounded-lg p-2 ml-4"> <img src={unban} style={{ width: '24px', height: '24px' }}></img> </button>
                    </div>
                </div>
                </div>
            </div>
