...
const UserList = ({ users }) => {
  return (
    <div className="w-full h-8/10 flex  ">
            ...
            <div className="w-7/12 flex-col">
                <div className="w-full h-3/6  mb-3 mr-3 ml-3 bg-gray-200 rounded-lg">
                    <div className="w-full h-10/12 bg-gray-200 rounded-lg">
                        ...
                        <div className=" w-full justify-center flex mt-5">
                            ...
                            <button onClick={handleDisable} className=" bg-white rounded-lg p-2 ml-2"> <img src={ban} style={{ width: '24px', height: '24px' }}></img> </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full h-10/12 bg-gray-200 rounded-lg">
                    ...
                    <div class=" w-5/6">
                        ...
                        <button onClick={handleEnable} className=" bg-white rounded-lg p-2 ml-2"> <img src={unban} style={{ width: '24px', height: '24px' }}></img> </button>
                    </div>
                </div>
                </div>
            </div>
